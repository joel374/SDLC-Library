    ...
    return TransactionItems.map((val) => {
      return (
        <TransactionItem
          ...
          category={val.Book.Category.category_name}
        ...
        >
          ...
          >
            <Box mx={"auto"} my="auto">
              ...
              <Text>{moment(borrow_date).format("LLLL")}</Text>

              <Text fontWeight={"light"} fontSize="19px">
                Due Date
              </Text>

              <Text>{moment(due_date).format("LLLL")}</Text>
            </Box>
            ...
            <Box mx={"auto"} my="auto">
              ...
              {is_penalty ? (
                <>
                  ...
                  <Text>Rp. {total_penalty.toLocaleString("ID-id")}</Text>
                </>
              ) : null}
